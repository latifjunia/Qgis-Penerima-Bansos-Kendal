...
var style_PenerimaKISAPBN_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("KIS APBN");
    var labelText = "";
    size = 0;
    ...
    if (value > 12523.000000 && value <= 17486.333333) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 17486.333333 && value <= 22449.666667) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 22449.666667 && value <= 27413.000000) {
            style = [ new ol.style.Style({
