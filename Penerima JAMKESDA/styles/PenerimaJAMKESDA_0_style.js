...
var style_PenerimaJAMKESDA_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("JAMKESDA");
    var labelText = "";
    size = 0;
    ...
    if (value > 1326.000000 && value <= 2588.666667) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 2588.666667 && value <= 3851.333333) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 3851.333333 && value <= 5114.000000) {
            style = [ new ol.style.Style({
