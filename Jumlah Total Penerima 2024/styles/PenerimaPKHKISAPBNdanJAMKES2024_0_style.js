...
var style_PenerimaPKHKISAPBNdanJAMKES2024_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (value > 17398.000000 && value <= 23289.666667) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 23289.666667 && value <= 29181.333333) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 29181.333333 && value <= 35073.000000) {
            style = [ new ol.style.Style({
