...
var style_PenerimaPKHKISAPBNdanJAMKES2023_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("JMLH TOTAL");
    var labelText = "";
    size = 0;
    var labelFont = "10.725px \'MS Gothic\', sans-serif";
    ...
    if (value > 16534.000000 && value <= 22538.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 22538.000000 && value <= 28542.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 28542.000000 && value <= 34546.000000) {
            style = [ new ol.style.Style({
