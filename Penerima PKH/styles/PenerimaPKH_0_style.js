...
var style_PenerimaPKH_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("PKH");
    var labelText = "";
    size = 0;
    ...
    if (value > 1401.000000 && value <= 2050.666667) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 2050.666667 && value <= 2700.333333) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 2700.333333 && value <= 3350.000000) {
            style = [ new ol.style.Style({
